...
const issuerId = '3388000000022301521';
...
const credentials = require(process.env.GOOGLE_APPLICATION_CREDENTIALS || './key.json');
...
async function createPassObject(req, res) {
  ...
  'heroImage': {
    'sourceUri': {
      'uri': 'C:\Users\rodri\OneDrive\Imagens\wallpaper hd 4k for desktop ideas.jpg'
    }
  },
  'textModulesData': [
    {
