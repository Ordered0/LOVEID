...
class DemoGeneric {
              ...
              "twoItems": {
                ...
                "endItem": {
                  "firstValue": {
                    "fields": [
                      {
                        "fieldPath": "object.textModulesData['VALIDADE']",
                      },
                    ],
                  },
                },
              ...
              "twoItems": {
                "startItem": {
                  "firstValue": {
                    "fields": [
                      {
                        "fieldPath": "object.textModulesData['N_TITULO']",
                      },
                    ],
                  },
                },
                "endItem": {
                  "firstValue": {
                    "fields": [
                      {
                        "fieldPath": "object.textModulesData['EMISSAO']",
                      },
                    ],
                  },
                },
    ...
    let newObject = {
      ...
      'heroImage': {
        'sourceUri': {//imagem principal
          'uri': 'http://91.108.124.127:3000/imagens/' + IMAGEM
        },
        'contentDescription': {
          'defaultValue': {
            'language': 'en-US',
      ...
      'textModulesData': [//informações adicionais
      {
        "id": "CATEGORIA",
        "header": "CATEGORIA",
        "body": `${CATEGORIA}`,
      ...
      'linksModuleData': { 
        'uris': [
          {
            'uri': 'https://maps.app.goo.gl/2yjS5XJvxCcgxs6T6',
            'description': 'localização do clube',
            'id': 'LINK_MODULE_URI_ID'
          },
          {
            'uri': 'tel:04532642121',
            'description': 'telefone do clube',
      ...
      'barcode': {
        'type': 'QR_CODE',
        'value': 'https://sites.google.com/view/countryclubmedianeira/p%C3%A1gina-inicial'
      },
      'cardTitle': {
        'defaultValue': {
          'language': 'en-US',
          'value': 'MEDIANEIRA COUNTRY CLUBE'
        }
      },
      "subheader": {
        "defaultValue": {
   ...
   * @returns {string} An "Add to Google Wallet" link.
   */
  createJwtExistingObjects(issuerId,object_suffix,class_suffix) {
